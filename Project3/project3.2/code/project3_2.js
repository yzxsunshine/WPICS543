...
// function to get invert matrix of 4x4 matrix
...
// load gl until all the images are loaded
...
// set gl parameters for textures
...
// set gl parameters for cube map textures
...
function BumpMapShaderScript (shader, mvMatrix, projMatrix, pts, norms, cols, texs, tangs) {
	...
	gl.uniform1f( gl.getUniformLocation(shader.program, "withTexture"), renderTexture);
